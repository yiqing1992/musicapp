...
<div class="login-con">
  <div class="login">
    ...
    <div class="login_box">
      ...
      <!-- 可以简写为required -->
      <input v-model="phone" type="text" required /><label>用户名</label>
    </div>
    <div class="login_box">
      <input v-model="password" type="password" required="required" /><label>密码</label>
    </div>
    <a href="javascript:void(0)" @click="loginEvent">
      登录
      <span></span>
      <span></span>
      <span></span>
